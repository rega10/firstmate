...
The fork-only Bitwarden ceremony, Automic Vault, and Claude session-environment suites use their completed measurements from green fork CI run [35052209884](https://github.com/rega10/firstmate/actions/runs/35052209884) on 2026-09-16: 19806 ms, 37724 ms, and 69 ms respectively.
These are single-run measurements from the portable serial timing artifacts, not bounds on future durations.
