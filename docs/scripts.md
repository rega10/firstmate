...
| `fm-work-landed-lib.sh`       | Own the shared landed-work predicates (merged-PR proof and content-in-default fallback) teardown and the legacy Herdr repair both use |
...
| `fm-landed-lib.sh` | Own Recently Landed selection and artifact-display rules shared by Bearings and fleet snapshots |
