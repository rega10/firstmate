...
Refreshed 2026-08-24 on macOS 26.5.2 arm64, Node v24.19.0, against the globally installed `@earendil-works/pi-coding-agent` 0.83.0 (the same version as the installed `pi` CLI):
