...
config/orchestra-dashboard  optional absolute Orchestra checkout path for detached live-board refreshes on actionable watcher wakes and heartbeats; LOCAL, gitignored, and not inherited; see docs/configuration.md "Orchestra live-board refresh"
